...
#        print "pdb file: *%s*" % (pdb_file_name)
        ...
        params_file = get_params_file_string (num_chains, ligand_name) # this is the string containing all params files
        print "params file string = *%s*" % (params_file)
#        params_file = '%s.fa.params' % (ligand_name)

        #NOTE: THERE MAY BE MORE LIGAND FILES...IF THERE ARE MORE LIGAND RESIDUES
